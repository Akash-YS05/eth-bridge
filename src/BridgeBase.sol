...
interface IBUSDT is IERC20 {
    ...
    function burn(address _form, uint256 _amount) external;
}
...
contract BridgeBase is Ownable {
    ...
    //_tokenAddress is the bridge token address
    ...
    function depositEventOnOtherSide(address userAccount, uint256 _amount) public onlyOwner {
